...
function showAndHidePass() {
  var password_old = document.getElementById('psw_input_old');
  var password_new = document.getElementById('psw_input_new');
  var password_confirm = document.getElementById('pswinput_confirm');
  var toggler = document.getElementById('psw_input_icon');
  // var password = select('.fakepassword');
  // var toggler = select('.fakepasswordicon');
  if (password_old.type == 'password') {
    password_old.type = 'text';
    password_new.type = 'text';
    password_confirm.type = 'text';
    toggler.className = 'fa-solid fa-eye cursor-pointer p-2';
  } else {
    toggler.className = 'fa-solid fa-eye-slash cursor-pointer p-2';
