...
<div class="row d-flex justify-content-center align-items-center text-center vh-100">
  ...
  <div class="col-lg-6 mx-auto">
    <figure class="m-0">
      <!-- SVG START -->
      <svg class="col-sm-7" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 716.1 451.4" style="enable-background:new 0 0 716.1 451.4;" xml:space="preserve">
        <style type="text/css">
          .st0{fill:#1C2B6B;}
          ...
          <g>
            <g>
              <g>
                ...
                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="433.4638" y1="425.6624" x2="457.5618" y2="425.6624">
                  ...
                  <stop offset="0.7095" style="stop-color:#2274DD"></stop>
              ...
              <g>
                ...
                <path style="fill:url(#SVGID_00000096760458073354237120000000850511327322928539_);" d="M268.2,167.3H17.8
                  ...
                  <stop offset="0.4764" style="stop-color:#F4F4F4"></stop>
                ...
                <circle class="st8" cx="64.2" cy="120.8" r="5.6"></circle>
                  ...
                  <ellipse transform="matrix(0.1602 -0.9871 0.9871 0.1602 99.5971 358.7539)" class="st7" cx="260.6" cy="120.8" rx="12.5" ry="12.5"></ellipse>
              ...
              <g>
                ...
                <path class="st8" d="M69.8,210.6c0,3.1-2.5,5.6-5.6,5.6c-3.1,0-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6
                  ...
                  <ellipse transform="matrix(0.9239 -0.3827 0.3827 0.9239 -60.7714 115.7734)" class="st7" cx="260.6" cy="210.6" rx="12.5" ry="12.5"></ellipse>
              ...
              <g>
                ...
                <path class="st8" d="M69.8,390.2c0,3.1-2.5,5.6-5.6,5.6c-3.1,0-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6
                  ...
                  <ellipse transform="matrix(0.9239 -0.3827 0.3827 0.9239 -129.5015 129.4447)" class="st7" cx="260.6" cy="390.2" rx="12.5" ry="12.5"></ellipse>
            ...
            <g>
              ...
              <path style="fill:url(#SVGID_00000137129226461153485580000005490632567427690920_);" d="M445.2,307.9h-35.4
                ...
                <ellipse transform="matrix(0.7071 -0.7071 0.7071 0.7071 -72.2681 384.0805)" class="st0" cx="427.5" cy="279.3" rx="21" ry="21"></ellipse>
              <g>
            ...
            <g>
              <g>
                <path class="st17" d="M650,392.6c0,0-0.3,15,0,16.5c0.2,1.5-5.9,10.3-8.4,9.9c-2.5-0.4-7.5-1.2-8.2-2.1
                  ...
                  <stop offset="0" style="stop-color:#4E9CFF"></stop>
                  <stop offset="0.9844" style="stop-color:#176AD4"></stop>
                </linearGradient>
                ...
                <path style="fill:url(#SVGID_00000039128244350703429110000002452721561931330230_);" d="M585.4,64.7
                  ...
                  <stop offset="0" style="stop-color:#F2BFAD"></stop>
                  <stop offset="0.7043" style="stop-color:#F2DAD4"></stop>
                </linearGradient>
    ...
    <!-- Offline info -->
    <h1 class="mb-2 display-5 mt-5">لقد إنتهى إشتراك المدرسة !</h1>
    <p class="col-sm-8 mx-auto">لقد إنتهى إشتراك المدرسة في موقعنا و لا يمكن للمدرسة بالإستفادة من مذايا المنصة إلى بعد تجديد الإشتراك.</p>
    <a class="btn btn-primary-soft btn-sm" href="index.html">تجديد الإشتراك</a>
  </div>
  <!-- Offline START -->
</div>
@endsection
